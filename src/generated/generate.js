...
var fs = require('fs');
var SCHEMA_URL = 'http://localhost:8088/accounts/api';
var HEADERS = {
...
function generateOps() {
    return __awaiter(this, void 0, void 0, function () {
        var introspection, schema, printedSchema;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, graphql_request_1.request)({
                        url: SCHEMA_URL,
                        document: (0, graphql_1.getIntrospectionQuery)(),
                        requestHeaders: HEADERS,
                    })];
                case 1:
                    introspection = _a.sent();
                    schema = (0, graphql_1.buildClientSchema)(introspection);
                    printedSchema = (0, graphql_1.printSchema)(schema);
